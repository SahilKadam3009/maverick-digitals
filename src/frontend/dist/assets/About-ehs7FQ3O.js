import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as Linkedin, T as Twitter, I as Instagram, L as Link, B as Button } from "./index-Cq-zlbre.js";
    ...
    function draw() {
      ...
      for (let xi = 0; xi < cols; xi += DOT_STEP) {
        for (let yi = 0; yi < rows; yi += DOT_STEP) {
          ...
          const colorBase = getColor(t);
          const dotOpacity = pulsedOpacity * 1.8 * (0.7 + 0.3 * Math.sin(phase + xi * 0.3 + yi * 0.4));
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChromaGrid, { isMuskan }),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeIcon, { size: 16, className: "text-background" })
                    }
                  )
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4 relative z-10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "font-display font-bold text-2xl mb-2 tracking-tight",
                  style: {
                    background: isMuskan ? "linear-gradient(135deg, #c084fc, #ffffff)" : "linear-gradient(135deg, #22d3ee, #ffffff)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    background: isMuskan ? "rgba(168,85,247,0.18)" : "rgba(34,211,238,0.15)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-5 justify-center relative z-10", children: member.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.span,
              {
                ...
                style: {
                  ...
                  color: isMuskan ? "rgba(216,180,254,0.9)" : "rgba(103,232,249,0.9)"
                },
                children: skill
              },
              skill
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 relative z-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  height: "45%",
                  background: isMuskan ? "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(168,85,247,0.10) 0%, transparent 70%)" : "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(34,211,238,0.08) 0%, transparent 70%)",
                  zIndex: 1
                }
              }
            ),
