import { r as reactExports, j as jsxRuntimeExports, a as createSlot$1, c as cn, b as composeRefs, o, d as useComposedRefs, e as reactDomExports, R as React, v as vt } from "./index-poG6khx8.js";
import { c as createLucideIcon } from "./createLucideIcon-CUWyxzox.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-BSU4e2D_.js";
import { b as useSubmitContact } from "./useQueries-DJjBVnL5.js";
import { m as motion } from "./proxy-CWr-aRNB.js";
/**
...
function ParticleField() {
  ...
  reactExports.useEffect(() => {
    ...
    const count2 = window.innerWidth < 768 ? 18 : 40;
...
function Contact() {
  ...
  const fieldClass = (field) => `premium-input ${touched[field] && errors[field] ? "border-destructive/70 focus:border-destructive dark:border-destructive/60" : ""}`;
  const resetForm = () => {
    setSubmitted(false);
    setForm({
      name: "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-20 sm:pt-28 pb-24 min-h-screen overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleField, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-glow-bg opacity-15 pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-0 w-96 h-96 bg-primary/5 rounded-full blur-[160px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 right-0 w-80 h-80 bg-secondary/5 rounded-full blur-[120px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag-label", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Whether you're starting fresh or scaling an existing brand — we map out a custom path to measurable growth. Real strategy, real results."
              }
            )
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: PROOF_STATS.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-black text-sm gradient-text-purple", children: value }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: leftRef,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-7 relative overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "We don't just run campaigns — we build growth systems tailored to your brand. From brief to delivery, you work directly with the founders." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card p-5 space-y-1", children: CONTACT_DETAILS.map(({ label, value, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest leading-none mb-1 font-semibold", children: label }),
                    href ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: value })
                      }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mb-4 font-bold", children: "Why Maverick?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: TRUST_POINTS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full gradient-neon-purple flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "svg",
                        {
                          width: "9",
                          height: "9",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mb-4 font-bold", children: "Follow Us" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: SOCIAL_LINKS.map(({ label, href, color }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href,
                    "aria-label": label,
            ...
            children: submitted ? (
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-accent/4 pointer-events-none rounded-2xl" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full gradient-neon-purple glow-neon flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-4xl font-bold", children: "✓" }) }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground/60 text-sm mb-10", children: [
                            "Check your inbox at",
                            " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "form",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-64 h-64 bg-primary/4 rounded-full blur-[100px] pointer-events-none" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-48 h-48 bg-accent/4 rounded-full blur-[80px] pointer-events-none" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-label mb-3 inline-flex", children: "Start a Conversation" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "The more you share, the better we can tailor our approach."
                        }
                      )
                    ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2.5 justify-center", children: [
                          ...
                          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-2.5 justify-center", children: "Send Message" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-primary/5 border border-primary/12", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-primary/70 shrink-0" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                          "Response within",
                          " ",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "24 hours" }),
                          " ",
