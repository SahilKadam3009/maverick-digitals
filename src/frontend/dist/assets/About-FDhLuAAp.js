import { c as createLucideIcon, r as reactExports, o, j as jsxRuntimeExports, a as Linkedin, T as Twitter, I as Instagram, L as Link, B as Button } from "./index-Dbh9EF2j.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-background overflow-hidden", children: [
      ...
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-6", style: { zIndex: 10 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-12 justify-center items-center md:items-start w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4", children: stats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatBadge, { stat, index: i }, stat.label)) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
