import { c as createLucideIcon, r as reactExports, o, j as jsxRuntimeExports, u as useTheme, a as Linkedin, T as Twitter, I as Instagram, L as Link, B as Button } from "./index-B1zXcz6L.js";
...
import { C as CodeXml } from "./code-xml-BkGGW3AG.js";
...
function StatBadge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-2xl sm:text-4xl gradient-text-purple mb-1", children: stat.value }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-xl mx-auto", children: "Two people building one focused team — with a single goal of helping good brands grow in ways that last." })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 sm:gap-12 justify-center items-center md:items-start w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xs", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "Founder & Brand Strategist — she's obsessed with storytelling that moves people and positioning that sticks. Muskan has built personal brands and growth strategies for founders and businesses across India and global markets." }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center mt-3", children: [
                            "Brand Strategy",
                            "Growth Marketing",
                            "Storytelling",
                            "Personal Branding"
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-3 mt-4", children: teamMembers[0].socials.map(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-xs", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "Co-Founder & Tech Lead — Dhaval builds the platforms that make everything else possible. 5+ years in the MERN stack, focused on sites and apps that are fast, clean, and built to convert." }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center mt-3", children: [
                            "Web Development",
                            "App Development",
                            "MERN Stack",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-3 mt-4", children: teamMembers[1].socials.map(
                            ({ icon: Icon, href, label, color }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "a",
                              {
                                href,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl md:text-5xl text-foreground text-center mb-10 leading-tight", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "font-display font-bold text-2xl sm:text-3xl md:text-5xl lg:text-6xl leading-tight", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg mt-8 max-w-2xl mx-auto leading-relaxed", children: "Creativity, strategy, and technical execution — brought together for brands that want to grow properly. We're active across India, UAE, USA, UK, and Australia." })
              ]
            }
          )
        ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base leading-relaxed max-w-sm", children: "Every milestone happened because the team kept showing up and doing the work — no shortcuts, no overpromising, just consistent effort and honest results." })
                ]
              }
            ) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed mb-10 max-w-xl mx-auto", children: "Your brand has a story worth telling. Let's make sure the right people actually hear it." }),
