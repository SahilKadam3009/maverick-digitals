import { c as createLucideIcon, j as jsxRuntimeExports, Z as Zap, L as Link, B as Button, r as reactExports } from "./index-BIdGjne6.js";
import { B as Badge } from "./badge-JtReC_7W.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-Bt_pFBLP.js";
import { S as Search } from "./search-BxCFAtjt.js";
import { C as ChartColumn, F as FileText, L as Lightbulb, R as Rocket, G as Globe } from "./rocket-DBNlhokX.js";
import { T as TrendingUp } from "./trending-up-DWcBEDEI.js";
import { A as ArrowRight } from "./arrow-right-CfcxaIWM.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-20 sm:pt-24 pb-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-4xl sm:text-5xl md:text-7xl text-foreground leading-[1.05] mb-6", children: [
              "Our ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-28", "data-ocid": "methodology-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative glassmorphic-dark border border-white/8 rounded-2xl p-6 sm:p-10 md:p-14", children: [
        ...
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative px-6 sm:px-10 py-12 sm:py-16 md:py-20 text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-3xl sm:text-4xl md:text-6xl text-foreground mb-6 leading-tight", children: [
