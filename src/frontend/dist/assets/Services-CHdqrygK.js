import { c as createLucideIcon, j as jsxRuntimeExports, L as Link, B as Button, r as reactExports } from "./index-B1zXcz6L.js";
import { B as Badge } from "./badge-BUjawb_5.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-DIBe60AQ.js";
import { S as Search } from "./search-YRjRbGkP.js";
import { C as ChartColumn, F as FileText, S as Share2, L as Lightbulb, R as Rocket, G as Globe, M as Megaphone } from "./share-2-DOS_P8DW.js";
import { T as TrendingUp } from "./trending-up-DyuGZMNX.js";
import { Z as Zap } from "./zap-BPqhgLxh.js";
import { A as ArrowRight } from "./arrow-right-BtlbFXsa.js";
/**
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-7", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-foreground/8 mb-5" }),
    ...
    "div",
    {
      ...
      children: [
        !isLast && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:block absolute top-10 left-[calc(50%+3rem)] right-[calc(-50%+3rem)] h-px", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-full bg-gradient-to-r from-foreground/15 via-foreground/8 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-foreground/15" })
        ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-20 sm:pt-24 pb-20 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-28", "data-ocid": "methodology-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-card dark:bg-card/70 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-2xl p-6 sm:p-10 md:p-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 border border-black/10 dark:border-white/10 rounded-2xl" }),
