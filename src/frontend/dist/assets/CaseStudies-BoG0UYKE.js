import { r as reactExports, j as jsxRuntimeExports, L as Link, B as Button } from "./index-DWTeTlWw.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-DETZ_JQ6.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, c as usePresence, b as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion } from "./proxy-CgKmb2WF.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-glow-bg opacity-15" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-card/55 backdrop-blur-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative p-6 md:p-12 flex flex-col md:flex-row gap-6 sm:gap-10 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `tag-label ${colors.badge}`, children: "Featured Case Study" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2.5 py-1 rounded-full bg-card/80 border border-border/60 text-muted-foreground", children: study.industry })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-semibold mb-2 uppercase tracking-wider", children: study.client }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-8", children: study.categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-1 gap-3 w-full sm:w-auto sm:min-w-[200px]", children: study.metrics.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
    ...
    motion.div,
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-display font-black text-3xl ${colors.metric}`, children: study.kpi }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 rounded-full bg-black/30 text-foreground border border-white/10", children: study.industry }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-4 leading-tight", children: study.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5 mb-5 flex-1", children: rowItems.map(({ label, text }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2.5 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0 mt-0.5 border ${colors.tag}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-bold leading-none", children: label[0] })
              }
            ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-5", children: study.categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function FilterPill({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      ...
      className: `relative px-5 py-2 rounded-full text-sm font-semibold transition-all duration-300 border ${active ? "border-primary/50 text-foreground" : "border-border/50 text-muted-foreground hover:border-border/80 hover:text-foreground glass-card"}`,
      children: [
...
function HeroSection() {
  const { ref, style } = useRevealOnScroll(0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24 sm:pt-28 pb-12 sm:pb-16", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-label", children: "Case Studies" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.h1,
...
function CaseStudies() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-background min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 pb-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "tag-label", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/12 via-accent/8 to-secondary/10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 grid-glow-bg opacity-15" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative px-6 sm:px-8 md:px-16 py-10 sm:py-12 md:py-16 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tag-label inline-flex mb-5", children: "Ready to be next?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-black text-4xl md:text-5xl text-foreground mb-4 leading-tight mt-2", children: [
                "Let's Build Your",
                " ",
