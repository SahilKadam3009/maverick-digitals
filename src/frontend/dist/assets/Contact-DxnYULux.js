import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, e as createSlot$1, b as cn, f as composeRefs, o, g as useComposedRefs, h as reactDomExports, R as React, v as vt, M as Mail, P as Phone, i as MapPin, I as Instagram, a as Linkedin, T as Twitter, B as Button } from "./index-B1zXcz6L.js";
import { I as Input } from "./input-DHlrCf-H.js";
import { a as ChevronDown, C as CircleCheckBig, S as Send } from "./send-BGZwyKMk.js";
import { u as useRevealOnScroll } from "./useIntersectionObserver-DIBe60AQ.js";
import { b as useSubmitContact } from "./useQueries-B-hESXyl.js";
import { S as Star } from "./star-BVZR4aYv.js";
import { Z as Zap } from "./zap-BPqhgLxh.js";
import { E as ExternalLink } from "./external-link-CV75-cEv.js";
/**
...
function ParticleField() {
  ...
  reactExports.useEffect(() => {
    ...
    const count2 = window.innerWidth < 768 ? 20 : 45;
...
function Contact() {
  ...
  const inputBase = "bg-background/80 dark:bg-muted/20 border transition-all duration-300 focus:ring-0 h-11 text-foreground placeholder:text-muted-foreground/50 rounded-lg";
  const fieldClass = (field) => `${inputBase} ${touched[field] && errors[field] ? "border-destructive/70 focus:border-destructive" : "border-border hover:border-primary/30 focus:border-primary/60 focus:shadow-[0_0_0_3px_oklch(var(--primary)/0.10)]"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pt-20 sm:pt-24 pb-24 min-h-screen overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-0 w-96 h-96 bg-primary/6 rounded-full blur-[140px] pointer-events-none" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/3 right-0 w-80 h-80 bg-secondary/6 rounded-full blur-[120px] pointer-events-none" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-5xl md:text-6xl text-foreground leading-tight mb-5", children: [
              "Let's build something",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-purple", children: "great together" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "Whether you're starting fresh or scaling an existing brand — we map out a custom path to measurable growth. Real strategy, real results." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: leftRef,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden border border-primary/15 bg-card/80 dark:bg-card/60 backdrop-blur-xl p-7", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest text-primary mb-3 block", children: "Maverick Digitals — Mumbai" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-2xl md:text-3xl text-foreground leading-tight mb-3", children: [
                    "Your growth partner,",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-cyan", children: "not just an agency." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "We don't just run campaigns — we build growth systems tailored to your brand. From brief to delivery, you work directly with the founders." })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", "data-ocid": "contact.stats", children: PROOF_STATS.map(({ value, label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 14, className: "text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-black text-xl gradient-text-purple leading-none", children: value }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground leading-tight mt-0.5 truncate", children: label })
                    ] })
                  ]
                },
                label
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border bg-card/70 dark:bg-card/50 backdrop-blur-xl p-5 space-y-4", children: CONTACT_DETAILS.map(({ icon: Icon2, label, value, href }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/8 border border-primary/15 flex items-center justify-center shrink-0 group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 15, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-wider leading-none mb-0.5", children: label }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card/70 dark:bg-card/50 backdrop-blur-xl p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mb-4 font-semibold", children: "Why Maverick?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: TRUST_POINTS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card/70 dark:bg-card/50 backdrop-blur-xl p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase tracking-widest mb-4 font-semibold", children: "Follow Us" }),
          ...
          "div",
          {
            ...
            children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/6 via-transparent to-accent/4 pointer-events-none rounded-2xl" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-full gradient-neon-purple glow-neon flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 44, className: "text-white" }) }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed max-w-sm mb-2", children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "24 hours" }),
                      "."
                    ] }),
              ...
              "form",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-56 h-56 bg-primary/4 rounded-full blur-[80px] pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-40 h-40 bg-accent/4 rounded-full blur-[60px] pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-primary uppercase tracking-widest mb-1", children: "Start a Conversation" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl md:text-3xl text-foreground", children: "Tell us about your goals" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "The more you share, the better we can tailor our approach." })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        ...
                        Select,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              SelectTrigger,
                              {
                                className: `h-11 bg-background/80 dark:bg-muted/20 border text-foreground transition-all duration-300 rounded-lg ${touched.serviceType && errors.serviceType ? "border-destructive/70" : "border-border hover:border-primary/30 focus:border-primary/60"}`,
                                "data-ocid": "contact-select-service",
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Choose a service..." })
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "glassmorphic z-50", children: SERVICE_TYPES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              SelectItem,
                              {
                                value: s,
                      ...
                      touched.serviceType && errors.serviceType && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-destructive text-xs mt-1",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        ...
                        {
                          value: form.budget,
                          onValueChange: (v2) => setForm({ ...form, budget: v2 }),
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              SelectTrigger,
                              {
                                ...
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a range..." })
                              }
                            ),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "glassmorphic z-50", children: BUDGET_RANGES.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              SelectItem,
                              {
                                value: b,
                                className: "cursor-pointer",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 py-2 px-4 rounded-lg bg-primary/5 border border-primary/10", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 13, className: "text-primary shrink-0" }),
